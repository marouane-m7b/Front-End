...
function CreateModerateur({ handleOpen, handleReload }) {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const res = await axios.post(`/api/moderateur`, formData, {
        headers: {
...
CreateModerateur.propTypes = {
  handleOpen: PropTypes.func.isRequired,
  handleReload: PropTypes.func.isRequired,
};

export default CreateModerateur